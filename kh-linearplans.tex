...
The set of formulas (a.k.a. the language) of $\Khlogic$ is defined by the following BNF:\raul{esta def. para mi deberia ir en un env. de def., por uniformidad.}\pedro{dejalo como est\'a: est\'a bueno para la redacci\'on introductoria de la secci\'on, adem\'as de que no veo la necesidad uniformidad los dos environments de definici\'on para las sem\'anticas.}
%
\[
