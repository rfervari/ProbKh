...
%%     \end{definition}
    ...
    \raul{en Areces et al. se muestra para U finitos, donde cada $Pi$ en U es finito; en DemriF23 se prueba para U finitos donde cada clase viene dada por un automata finito.}
