...
\begin{example}\label{ex:running:plans-exec}
  ...
  $\plans_{\star}$-compatible strategy $\strat_5$ defined as
  %
  \[
  \begin{array}{l}
...
\cref{eq:plans:goal:q}\textcolor{red}{, meaning she can adapt to the course of action in $\plans$ with the best chance of success.}
...
Logics $\PKhunc$ and $\PKhadapt$ are not \textcolor{red}{directly}\raul{pongo 'directly' porque esto no es demo en terminos de expresividad.} related.
%
On the one hand
