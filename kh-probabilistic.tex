...
\begin{definition}\label{def:pltsu}
    ...
    \powerset(\Act^*)\setminus \emptyset$ is an agent's perception.
\end{definition}
...
\emph{probabililisticly}
\pedro{Cuidado! aunque les suene que deber\'ia ser ``probabilistic\textbf{al}ly'' esto \'ultimo es una transliteraci\'on incorrecta}
quantified for each $\plans$-compatible
