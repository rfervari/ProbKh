...
\emph{in an adaptive manner}: \textcolor{red}{she can adapt to the course of action in $\plans$ with the best chance of success.}
\pedro{\textbf{@Ra\'ul:} no necesariamente con las mejores chances de \'exito: Ver  $\modelex^3$ en \Cref{fig:counterexamples} y p\'arrafo luego de \Cref{ex:running:pkhadapt} que lo explica. Fijate si te gusta m\'as lo que est\'a en azul.}%
\textcolor{blue}{This means that the agent can adapt to the course of action in $\plans$ according to the available decisions along the chosen execution path.}
...
\begin{proof}
  ...
  \bigraul{estoy de acuerdo, la dejo de momento para chequearla nomas}
  {\color{red}
...
validity of $\kh^q(\psi,\chi)$ and, in \cref{alg:ln:retfalse}, it
