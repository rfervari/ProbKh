...
% syntax
\newcommand{\ability}{\operatorname{\mathsf{S}}}
\newcommand{\obliged}{\operatorname{\mathsf{O}}}
\newcommand{\normed}{\operatorname{\mathsf{N}}}
\newcommand{\kh}{{\mathsf{Kh}}}
\newcommand{\khi}{{\mathsf{Kh}_i}}
\newcommand{\kc}{{\mathsf{Kc}}}
\newcommand{\kci}{{\mathsf{Kc}_i}}
\newcommand{\arbitrary}{{\mathsf{X}}}
\newcommand{\permitted}{\operatorname{\mathsf{P}}}
...
\newcommand{\post}{\mathcal{Q}}
\newcommand{\other}{\mathcal{R}}
\newcommand{\pres}{\mathbb{P}}
\newcommand{\posts}{\mathbb{Q}}
\newcommand{\rels}{\mathbb{R}}

\newcommand{\sign}{\gamma}

\newcommand{\witness}{\mathbb{W}}
\newcommand{\WITNESS}{\mathbf{W}}

\newcommand{\closed}{Cl}
\newcommand{\size}[1]{{|}{#1}{|}}
\newcommand{\demand}{dem}
\newcommand{\universe}{st}
\newcommand{\labels}{lbl}
\newcommand{\subform}{sf}

%\renewcommand{\models}{\vDash}
\newcommand{\modelsQBF}{\Vdash}
% languages
%\newcommand{\KHilogic}{\ensuremath{\sf DKhL}\xspace}
\newcommand{\kclogic}{\ensuremath{\sf DLKc}\xspace}
\newcommand{\KHlogic}{\ensuremath{\mathsf{L}_{\kh}}\xspace}
\newcommand{\QBFlogic}{\ensuremath{\mathsf{QBF}}\xspace}
...
\newcommand{\carlos}[1]{\todo[color=green!20]{{\bf Carlos:} #1}\xspace}
\newcommand{\bigcarlos}[1]{\todo[inline,color=green!20]{{\bf Carlos:} #1}}
...
\DeclareMathOperator{\unsat}{\mathsf{Unsat}}
\DeclareMathOperator{\taut}{TQBF}
\DeclareMathOperator{\binnum}{bin}
